    ...
    public static class SmaliUtils
    {
        ...
        public class SubPatchModule<T>
        {
            ...
            public class Properties
            {
                ...
                public void ReadNewLinesFromPath(string smaliPartialPath)
                {
                    NewPath =
                        smaliPartialPath.Replace('/', '\\').GetSmaliFileFullPath();
                    NewLines =
                    ...
                    foreach (var injectionInfo in injectionsInfo)
                    {
                        ...
                        Log.PatchLog(
                            isLines
                                ...
                                :
                                    smaliPropertiesInstance.NewPath,
        ...
        {
            return Regex.Matches(value, reference).Count == count ? true : false;
        }
    }
}