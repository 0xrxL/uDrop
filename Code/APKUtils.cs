...
namespace uDrop.Code
{
    public class APKUtils
    {
        ...
        public static void Integrations()
        {
            ...
            foreach (var integrationFile in integrationFiles)
            {
        ...
        public static void Sign()
        {
            ...
            if (signKeyFilesExists)
            {
                ...
                startInfo = new()
                {
                    WindowStyle = ProcessWindowStyle.Hidden,
                    FileName = "cmd.exe",
                    Arguments = $"/C java -jar {apksignerPath} sign --ks {signKeyFilePaths[0]} --ks-key-alias {signKeyInfoDeserialized.Alias} --ks-pass pass:{signKeyInfoDeserialized.Pass} {Init.apkModdedPath}",
                    RedirectStandardOutput = true,
                    RedirectStandardError = true
                };
                process.StartInfo = startInfo;
