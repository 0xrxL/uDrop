...
public class uBlocker {
    ...
    public static synchronized boolean HideLithoTemplate(StringBuilder templateTreeComponents) {
        ...
        String strProtoBufferComponents = StandardCharsets
                                            .UTF_8
                                            .decode(protoBufferComponents)
                                            .toString()
                                            .replaceAll("[^\\x20-\\x7E]", "");
        ...
        //----------------------------Stable Volume Flyout Button----------------------------//
            if (strTemplateTreeComponents.contains("bottom_sheet_list_option") &&
                strProtoBufferComponents.contains("volume_stable")) {
                    return true;
            }
        //-----------------------------------------------------------------------------------//
