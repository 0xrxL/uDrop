...
public class uBlocker {
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> LIGHT_COLORS =
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> DARK_COLORS =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> commentsComponents =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> horizontalShelfFirst =
        InitializeNewBlockList(
            Set.of(
                "cell_divider",
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> horizontalShelfSecond =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> openCommentsButtonComponents =
        InitializeNewBlockList(
            Set.of(
                "carousel_header",
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> sponsorShipPanelComponents =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> videoInformationPanelComponents =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> videoLookupComponents =
        InitializeNewBlockList(
            Set.of(
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> generalComponents =
        InitializeNewBlockList(
            Set.of(
            //------------------------------------------ADS------------------------------------------//
    ...
    private static final AbstractMap.SimpleEntry<StringAhoCorasick, Integer> topbarButtons =
        InitializeNewBlockList(
            Set.of(
                "CREATION_ENTRY",
                "FAB_CAMERA",
