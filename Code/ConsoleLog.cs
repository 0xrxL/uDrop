...
namespace uDrop.Code
{
    public static class ConsoleLog
    {
        ...
        public static void LogFound(this string message, bool removeLastLine)
        {
            Print(message, ConsoleColor.Cyan, removeLastLine);
        }
        public static void LogFound(this string message, string patch, bool removeLastLine)
        {
            Print($"{message} ---> {patch}", ConsoleColor.Cyan, removeLastLine);
        }
        public static void LogFound(this string message, int indexLine, bool removeLastLine)
        {
            Print($"{message} ---> Line {indexLine}", ConsoleColor.Cyan, removeLastLine);
        }
        public static void LogFound(this string message, string patch, int indexLine, bool removeLastLine)
        {
            Print($"{message} ---> {patch} ---> Line {indexLine}", ConsoleColor.Cyan, removeLastLine);
        }
