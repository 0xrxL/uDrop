    ...
    public class YouTube
    {
        ...
        public static List<(bool, bool)> Non_Root()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45532100),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45690090),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45690091),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45665455),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45645570),
                        "move-result "
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45355374),
                        "move-result "
                    ],
        ...
        public static List<(bool, bool)> Amoled_App_Color_Tint()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(16842919),
                        SmaliUtils.GetResourceHexByName(16843518),
            ...
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        ...
                        "\"unsupported op code: \"",
                        $"const/4 {SmaliUtils.GetResourceHexByName(0)}",
                        $"const/4 {SmaliUtils.GetResourceHexByName(5)}",
                        $"const/4 {SmaliUtils.GetResourceHexByName(2)}",
                        $"const/4 {SmaliUtils.GetResourceHexByName(3)}",
                        ".method"
                    ],
        ...
        public static List<(bool, bool)> Generic_Improvements()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45685201),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45632194),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45371931),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45680008),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45680009),
                        ".method )Z"
                    ],
...
new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45694309),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45701806),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45387489),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45675738),
                        "move-result "
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45643739),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45686474),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45709810),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45713296),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45691569),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45690475),
                        ".method )Z"
                    ],
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45672269),
                        "move-result "
                    ],
                                                         ...
                                                         if (xmlSmaliProperties.Lines[l].PartialsContains(targetSearchTerms[3]))
                                                         {
                                                             for (int m = l; m >= scaleIndex.Lines(l, -5); m--)
                                                             {
                                                                 if (xmlSmaliProperties.Lines[m].PartialsContains(targetSearchTerms[4]))
                                                                 {
                                                                    ...
                                                                    {
                                                                        if (xmlSmaliProperties.Lines[n].PartialsContains(targetSearchTerms[5]))
                                                                        {
                                                                            for (int o = n; o >= scaleIndex.Lines(n, -5); o--)
                                                                            {
                                                                                if (xmlSmaliProperties.Lines[o].PartialsContains(targetSearchTerms[6]))
                                                                                {
                                                                                    for (int p = o; p >= scaleIndex.Lines(o, -7); p--)
                                                                                    {
                                                                                        if (xmlSmaliProperties.Lines[p].PartialsContains(targetSearchTerms[7]))
                                                                                        {
                                                                                            codeInject.Lines(
                                                                                                [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                     [
                         SmaliUtils.GetResourceHexByName(45638483),
                         "move-result "
                     ],
                 ...
                 new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45427407),
                        ".method )Z"
                    ],
        ...
        public static List<(bool, bool)> Litho_Elements_Removal()
        {
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45419603),
                        "move-result "
                    ],
        ...
        public static List<(bool, bool)> Top_And_Navigation_Bars_Buttons_Removal()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(318370164),
        ...
        public static List<(bool, bool)> Video_Quality()
        {
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(45400072),
                        ".method )Z"
                    ],
        ...
        public static List<(bool, bool)> Video_Reload_After_Timeout()
        {
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHexByName(257),
                        SmaliUtils.GetResourceHexByName(226205),
