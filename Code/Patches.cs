namespace uDrop.Code
{
    public class YouTube
    {
        ...
        private static readonly string uSpoofingPath =
            $"{uToolsRootFolder}/StreamSpoofing/uSpoofing";
                            ...
                            for (int i = 0; i < smaliProperties.LinesCount; i++)
                            {
                                    ...
                                    }.All(smaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j < smaliProperties.LinesCount; j++)
                                    {
                                        ...
                                        {
                                            string[] patch = [
                                                $"invoke-static {{v0}}, L{uBlockerPath};->SetSystemTheme(Ljava/lang/Enum;)V"
                                            ];
                                                    ...
                                                    codeInject.Lines(
                                                        [
                                                            ...
                                                            [
                                                                ...
                                                                $"sput-boolean v1, L{uBlockerPath};->isDarkTheme:Z"
                                                            ])
                                                        ]
                                                    ).Write();
                                                }
                                                    ...
                                                    }.All(smaliProperties.Lines[k].Contains))
                                                {
                                                    codeInject.Lines(
                                                        [
                                                            ...
                                                            [
                                                                $"invoke-static {{{smaliProperties.Lines[k].GetRegister(1)}}}, L{uBlockerPath};->DisableAutoPlayCountdown(Landroid/view/View;)V"
                                                            ])
                                                        ]
                                                    ).Write();
                            ...
                            for (int i = 0; i < smaliProperties.LinesCount; i++)
                            {
                                    ...
                                    }.All(smaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j >= scaleIndex.Lines(i, -114); j--)
                                    {
                                        ...
                                        {
                                            smaliProperties.ReadNewLinesFromPath(smaliProperties.Lines[j].GetInvokedSectionClass(1));

                                            for (int k = 0; k < smaliProperties.NewLinesCount; k++)
                                            {
                                                if ((smaliProperties.Lines[j].GetMethodName<string[]>() as string[])!
                                            ...
                                            for (int k = j; k <= scaleIndex.Lines(j, 262); k++)
                                            {
                                                    ...
                                                    }.All(smaliProperties.Lines[k].Contains))
                                                {
                                                    for (int l = k; l <= scaleIndex.Lines(k, 20); l++)
                                                    {
                                                        ...
                                                        {
                                                            smaliProperties.ReadNewLinesFromPath(smaliProperties.Lines[l].GetInvokedSectionClass(1));

                                                            for (int m = 0; m < smaliProperties.NewLinesCount; m++)
                                                            {
                                                                if ((smaliProperties.Lines[l].GetMethodName<string[]>() as string[])!
                                                    ...
                                                    }.All(smaliProperties.Lines[k].Contains))
                                                {
                                                    codeInject.Lines(
                                                        [
                                                            ...
                                                            [
                                                                $"invoke-static {{{smaliProperties.Lines[k].GetRegister(1)}}}, L{uBlockerPath};->HideInstanceViewByLayoutParams(Landroid/view/View;)V"
                                                            ])
                                                        ]
                                                    ).Write();
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{{smaliProperties.Lines[j].GetRegister(1)}}}, L{uBlockerPath};->HideView(Landroid/view/View;)V"
                                                    ])
                                                ]
                                            ).Write();
                    ...
                    (
                            ...
                            }.All(smaliProperties.Full.Contains))
                        {
                            ...
                            for (int i = smaliProperties.LinesCount - 1; i >= scaleIndex.Lines(i, -10); i--)
                            {
                                ...
                                {
                                    smaliProperties.ReadNewLinesFromPath(smaliProperties.Lines[i].GetInvokedSectionClass(1));

                                    for (int j = 0; j < smaliProperties.NewLinesCount; j++)
                                    {
                                        if ((smaliProperties.Lines[i].GetMethodName<string[]>() as string[])!
                                    ...
                                    for (int j = i; j <= scaleIndex.Lines(i, 17); j++)
                                    {
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            for (int k = j; k >= scaleIndex.Lines(j, -25); k--)
                                            {
                                                ...
                                                {
                                                    smaliProperties.ReadNewLinesFromPath(smaliProperties.Lines[k].GetInvokedSectionClass(1));
                                                                    ...
                                                                    codeInject.NewLines(
                                                                        [
                                                                            ...
                                                                            [
                                                                                ...
                                                                                $"sput-object v0, L{uBlockerPath};->currentPlayerID:Ljava/lang/String;"
                                                                            ])
                                                                        ]
                                                                    ).Write();
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{}}, L{uBlockerPath};->CheckIsShortsPlayer()Z",
                                                        "move-result v0",
            ...
            return [
                                                            ...
                                                            }.All(smaliProperties.NewLines[l].Contains))
                                                        {
                                                            codeInject.NewLines(
                                                                [
                                                                    ...
                                                                    [
                                                                        $"sput {smaliProperties.NewLines[l].GetRegister(2)}, L{uBlockerPath};->currentNavBarIndex:I"
                                                                    ])
                                                                ]
                                                            ).Write();
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    ...
                    (
                        ...
                        if (smaliProperties.Path.EndsWith("\\overlay\\YouTubePlayerOverlaysLayout.smali"))
                        {
                            smaliProperties.ReadSmaliLines();
                                            ...
                                            for (int k = j; k < smaliProperties.LinesCount; k++)
                                            {
                                                    ...
                                                    }.All(smaliProperties.Lines[k].Contains))
                                                {
                                                    for (int l = k; l <= scaleIndex.Lines(k, 202); l++)
                                                    {
                                                        ...
                                                        {
                                                            for (int m = l; m < smaliProperties.LinesCount; m++)
                                                            {
                                                                if (new[] {
                                                                        smaliSearchKeys[7]
                                                                    }.All(smaliProperties.Lines[m].Contains))
                                                                            ...
                                                                            for (int o = n; o <= scaleIndex.Lines(n, 8); o++)
                                                                            {
                                                                                    ...
                                                                                    }.All(smaliProperties.Lines[o].Contains))
                                                                                {
                                                                                    for (int p = m; p >= scaleIndex.Lines(m, -12); p--)
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            string throwExceptionRegister = smaliProperties.Lines[m].GetRegister(1);
                                                                                            string stringBuilderFirstRegister = smaliProperties.Lines[l].GetRegister(1);
                                                                                            string stringBuilderSecondRegister = smaliProperties.Lines[l].GetRegister(2);
                                                                                            ...
                                                                                            codeInject.Lines(
                                                                                                [
                                                                                                    ...
                                                                                                    [
                                                                                                        $"if-nez {smaliProperties.Lines[p].GetRegister(1)}, :litho_tree",
                                                                                                        $"move-object/from16 {throwExceptionRegister}, p1",
                                                                                                        $"invoke-static {{{throwExceptionRegister}}}, {smaliProperties.Lines[n].GetInvokedSection()}",
                                                                                                        $"move-result-object {throwExceptionRegister}",
                                                                                                        $"iget-object {throwExceptionRegister}, {throwExceptionRegister}, {smaliProperties.Lines[o].GetInvokedSection()}",
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    ...
                    (
                        ...
                        if (new[] {
                                smaliSearchKeys[0],
                                smaliSearchKeys[1]
                            }.All(str => smaliProperties.Full.ReferenceEntriesCount(str, 2)))
                        {
                            smaliProperties.ReadSmaliLines();

                            for (int i = smaliProperties.LinesCount - 1; i >= 0; i--)
                            {
                                if (new[] {
                                        smaliSearchKeys[2],
                                        smaliSearchKeys[3]
                                                    ...
                                                    }.All(smaliProperties.Lines[k].Contains))
                                                {
                                                    codeInject.Lines(
                                                        [
                                                            ...
                                                            [
                                                                $"invoke-static {{{smaliProperties.Lines[k].GetRegister(1)}}}, L{uBlockerPath};->HideView(Landroid/view/View;)V"
                                                            ])
                                                        ]
                                                    ).Write();
                                                                            ...
                                                                            }.All(smaliProperties.Lines[n].Contains))
                                                                        {
                                                                            codeInject.Lines(
                                                                                [
                                                                                    ...
                                                                                    [
                                                                                        $"invoke-static {{{smaliProperties.Lines[n].GetRegister(1)}}}, L{uBlockerPath};->HideView(Landroid/view/View;)V"
                                                                                    ])
                                                                                ]
                                                                            ).Write();
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{{smaliProperties.Lines[j].GetRegister(1)}}}, L{uBlockerPath};->HideLiveChatSubscribersShelf(Landroid/view/View;)V"
                                                    ])
                                                ]
                                            ).Write();
                                    ...
                                    }.All(smaliProperties.Lines[i].Contains))
                                {
                                    codeInject.Lines(
                                        [
                                            ...
                                            [
                                                $"invoke-static {{{smaliProperties.Lines[i].GetRegister(1)}}}, L{uBlockerPath};->HideLiveChatCommunityRulesBox(Landroid/view/View;)V",
                                            ])
                                        ]
                                    ).Write();
                                    ...
                                    }.All(smaliProperties.Lines[i].Contains))
                                {
                                    codeInject.Lines(
                                        [
                                            ...
                                            [
                                                $"const v0, {smaliSearchKeys[3]}",
                                                $"if-ne {smaliProperties.Lines[i].GetRegister(2)}, v0, :hide_create_clip_button",
                                                $"invoke-static {{{smaliProperties.Lines[i].GetRegister(1)}}}, L{uBlockerPath};->HideImageView(Landroid/widget/ImageView;)V",
            ...
            return [
                new SmaliUtils.SubPatchModule<SmaliUtils.StringTransform[]>(
                    ...
                    (
                        ...
                        if (!smaliProperties.Path.Contains(uToolsRootFolder) &&
                            (smaliProperties.Path.EndsWith(".smali") ||
                            smaliProperties.Path.EndsWith("\\AndroidManifest.xml")))
                        {
                            if (smaliSearchKeys.Any(st => smaliProperties.Full.Contains(st.Original)))
                            {
                                codeInject.FullReplace(
                                                                    ...
                                                                    }.All(smaliProperties.Lines[m].Contains))
                                                                {
                                                                    for (int n = m; n <= scaleIndex.Lines(m, 9); n++)
                                                                    {
                                                                            ...
                                                                            }.All(smaliProperties.Lines[n].Contains))
                                                                        {
                                                                            ...
                                                                            smaliProperties.ReadNewLinesFromPath(firstClassName);
                                                                            ...
                                                                            smaliProperties.ReadNewLinesFromPath(secondClassName);
                                                                                ...
                                                                                }.Any(string.IsNullOrEmpty))
                                                                            {
                                                                                codeInject.Lines(
                                                                                    [
                                                                                        ...
                                                                                        [
                                                                                            $"invoke-direct {{{smaliProperties.Lines[n].GetRegister(2)}, {smaliProperties.Lines[n].GetRegister(1)}}}, L{smaliProperties.Lines[l].GetInvokedSectionClass(1)};->{Main_Class.apkInfo.Item3}_SetStreamingData(L{firstClassName};)V"
                                                                                        ])
                                                                                    ]
                                                                                );
            ...
            return [
                new SmaliUtils.SubPatchModule<SmaliUtils.StringTransform[]>(
                    ...
                    (
                        ...
                        if (smaliProperties.Path.EndsWith("\\settings_fragment_cairo.xml"))
                        {
                            if (smaliSearchKeys.All(st => smaliProperties.Full.Contains(st.Original)))
                            {
                                codeInject.FullReplace(
                                    [
                                    ...
                                    for (int j = i; j >= 0; j--)
                                    {
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            for (int k = j; k >= 0; k--)
                                            {
                                                ...
                                                {
                                                    smaliProperties.ReadNewLinesFromPath(uBlockerPath);
                                                                    ...
                                                                    }.All(smaliProperties.NewLines[m].Contains))
                                                                {
                                                                    codeInject.NewLines(
                                                                        [
                                                                            ...
                                                                            [
                                                                                $"const/4 v0, 0x0",
                                                                                $"invoke-static {{p0, v0, v0}}, L{Path.GetFileNameWithoutExtension(smaliProperties.Path)};->{(smaliProperties.Lines[k].GetMethodName<string>() as string)}(Landroid/view/View;II)V"
                                                                            ])
                                                                        ]
                                                                    ).Write();
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{{smaliProperties.Lines[j].GetRegister(1)}, {smaliProperties.Lines[j].GetRegister(2)}}}, L{uBlockerPath};->HideTabMyAccountGetPremium(Landroid/view/View;Ljava/lang/CharSequence;)V"
                                                    ])
                                                ]
                                            ).Write();
                                                            ...
                                                            }.All(smaliProperties.Lines[l].Contains))
                                                        {
                                                            codeInject.Lines(
                                                                [
                                                                    ...
                                                                    [
                                                                        $"invoke-static {{{smaliProperties.Lines[l].GetRegister(1)}}}, L{uBlockerPath};->HideTopbarButtons(Landroid/view/View;)V"
                                                                    ]),
                                                                    ...
                                                                    [
                                                                        $"sput-object {smaliProperties.Lines[k].GetRegister(1)}, L{uBlockerPath};->topBarPivot:Ljava/lang/Enum;"
                                                                    ])
                                                                ]
                                                            ).Write();
                                                                            ...
                                                                            }.All(smaliProperties.Lines[n].Contains))
                                                                        {
                                                                            codeInject.Lines(
                                                                                [
                                                                                    ...
                                                                                    [
                                                                                        $"invoke-static {{{smaliProperties.Lines[n].GetRegister(1)}}}, L{uBlockerPath};->HideNavigationbarButtons(Landroid/view/View;)V"
                                                                                    ]),
                                                                                    ...
                                                                                    [
                                                                                        $"sput-object {smaliProperties.Lines[l].GetRegister(1)}, L{uBlockerPath};->navigationBarPivot:Ljava/lang/Enum;"
                                                                                    ])
                                                                                ]
                                                                            ).Write();
                                            ...
                                            }.All(smaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{{smaliProperties.Lines[j].GetRegister(1)}}}, L{uBlockerPath};->OpenVideoResolutionsFlyout(Landroid/support/v7/widget/RecyclerView;)V"
                                                    ])
                                                ]
                                            ).Write();
