    ...
    public class YouTube
    {
                                    ...
                                    codeInject.Lines(
                                        [
                                            ...
                                            [
                                                ...
                                                $"invoke-static {{v0}}, L{uUtilsPath};->SetMainActivity(Landroid/app/Activity;)V"
                                            ])
                                        ]
                                    ).Write();
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j <= scaleIndex.Lines(i, 23); j++)
                                    {
                                            ...
                                            }.All(xmlSmaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    (("Comment Reply New Emoji Panel Button", true),
                            ...
                            }.All(xmlSmaliProperties.Full.Contains))
                        {
                            ...
                            for (int i = 0; i < xmlSmaliProperties.LinesCount; i++)
                            {
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    codeInject.Lines(
                                        [
                                            (("Leave Only Filtering Button", true),
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    codeInject.Lines(
                                        [
                                            ...
                                            [
                                                "move-object/from16 v0, p0",
                                                $"invoke-static {{v0}}, L{uBlockerPath};->CheckMicroGPackage(Landroid/app/Activity;)V"
                                            ])
                                        ]
                                    ).Write();
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j >= scaleIndex.Lines(i, -9); j--)
                                    {
                                            ...
                                            }.All(xmlSmaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    (("Newer Settings Layout Enabler", true),
                                            ...
                                            }.All(xmlSmaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        $"invoke-static {{}}, L{uUtilsPath};->GetCurrentStreamClientName()Ljava/lang/String;",
                                                        "move-result-object v0",
            ...
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    ...
                    (
                        ...
                        if (xmlSmaliProperties.Path.EndsWith("\\YouTubePlayerOverlaysLayout.smali"))
                        {
                            xmlSmaliProperties.ReadXMLSmaliLines();
        ...
        public static List<bool> Search_Trending_Suggestions_Removal()
        {
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHex(45353159),
                        "move-result "
                    ],
                                            ...
                                            codeInject.Lines(
                                                [
                                                    ...
                                                    [
                                                        ...
                                                        "invoke-static {v0}, LuTools/uBlocker;->HideSearchTrendingSuggestions(Ljava/lang/String;)Z",
                                                        "move-result v0",
                                                        "if-eqz v0, :hide_search_trending_suggestions",
                                                        "return-void",
        ...
        public static List<bool> Shorts_Elements_Removal()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHex(45631116),
                        "move-result "
                    ],
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j <= scaleIndex.Lines(i, 11); j++)
                                    {
                                            ...
                                            }.All(xmlSmaliProperties.Lines[j].Contains))
                                        {
                                            codeInject.Lines(
                                                [
                                                    (("Swipe To Next FullScreen Regular Video", true),
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    ...
                    (
                        ...
                        if (xmlSmaliProperties.Path.EndsWith("\\layout\\appwidget_two_rows.xml"))
                        {
                            xmlSmaliProperties.ReadXMLSmaliLines();
                            ...
                            for (int i = 0; i < xmlSmaliProperties.LinesCount; i++)
                            {
                                    ...
                                    }.All(xmlSmaliProperties.Lines[i].Contains))
                                {
                                    for (int j = i; j < xmlSmaliProperties.LinesCount; j++)
                                    {
                                        codeInject.LinesReplace(
                                            [
                                                (("System Launcher Widget Button", true),
                                        ...
                                        if (new[] {
                                                xmlSmaliSearchKeys[0]
                                            }.All(xmlSmaliProperties.Lines[j + 1].Contains))
                                        {
                                            codeInject.Write();
            ...
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        ...
                        SmaliUtils.GetResourceHex("id", "engagement_panel_content"),
                        SmaliUtils.GetResourceHex("dimen", "panel_header_non_content_height"),
                        "new-instance",
                        "check-cast",
                        "Lcom/google/protos/youtube/api/innertube/ShowEngagementPanelEndpointOuterClass$ShowEngagementPanelEndpoint;",
                        SmaliUtils.GetResourceHex(138681066),
                        "(Lcom/google/protos/youtube/api/innertube/ShowEngagementPanelEndpointOuterClass$ShowEngagementPanelEndpoint;)Ljava/lang/String;",
                        "move-result-object"
                    ],
                                    ...
                                    for (int j = i; j <= scaleIndex.Lines(i, 50); j++)
                                    {
                                            ...
                                            }.All(xmlSmaliProperties.Lines[j].Contains))
                                        {
                                            ...
                                            for (int k = 0; k < xmlSmaliProperties.NewLinesCount; k++)
                                            {
                                                ...
                                                {
                                                    for (int l = k; l <= scaleIndex.NewLines(k, 119); l++)
                                                    {
                                                        if (new[] {
                                                                xmlSmaliSearchKeys[6]
                                                            }.All(xmlSmaliProperties.NewLines[l].Contains))
                                                        {
                                                            for (int m = l; m <= scaleIndex.NewLines(l, 281); m++)
                                                            {
                                                                if (new[] {
                                                                        xmlSmaliSearchKeys[7]
                                                                    }.All(xmlSmaliProperties.NewLines[m].Contains))
                                                                {
                                                                    for (int n = m; n <= scaleIndex.NewLines(m, 6); n++)
                                                                    {
                                                                        if (new[] {
                                                                                xmlSmaliSearchKeys[8]
                                                                            }.All(xmlSmaliProperties.NewLines[n].Contains))
                                                                        {
                                                                            codeInject.NewLines(
                                                                                [
                                                                                    ...
                                                                                    [
                                                                                        $"if-nez {xmlSmaliProperties.NewLines[n].GetRegister(1)}, :start_video_shop_panel",
                                                                                        "return-void",
