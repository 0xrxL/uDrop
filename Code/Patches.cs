    ...
    public class YouTube
    {
        ...
        public static List<bool> Horizontal_Shelf_Removal()
        {
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                        SmaliUtils.GetResourceHex("layout", "player_overlays"),
                        "iput-object",
                        "invoke-virtual",
                        "iput-object",
                        " onTouch("
                                            ...
                                            for (int k = j; k <= scaleIndex.Lines(j, 5); k++)
                                            {
                                                    ...
                                                    }.All(xmlSmaliProperties.Lines[k].Contains))
                                                {
                                                    for (int l = k; l <= scaleIndex.Lines(k, 6); l++)
                                                    {
                                                        ...
                                                        {
                                                            xmlSmaliProperties.ReadXMLSmaliNewLines(xmlSmaliProperties.Lines[l].GetInvokedSectionClass(2));
                                                                    ...
                                                                    codeInject.NewLines(
                                                                        [
                                                                            ...
                                                                            [
                                                                                ...
                                                                                "move-result v0",
                                                                                "if-eqz v0, :horizontal_shelf_removal",
                                                                                "const/4 v0, 0x0",
                                                                                $"sput v0, L{uBlockerPath};->currentNavBarIndex:I",
                                                                                ":horizontal_shelf_removal"
                                                                            ])
                                                                        ]
                                                                    ).Write();
