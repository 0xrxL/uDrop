namespace uDrop.Code
{
    public class YouTube
    {
            ...
            return [
                ...
                new SmaliUtils.SubPatchModule<string[]>(
                    ...
                    (
                        ...
                        if (xmlSmaliProperties.Path.EndsWith(uDropUtils.GetOSSpecificFullPath("/ComponentTree.smali")))
                        {
                            xmlSmaliProperties.ReadXMLSmaliLines();
                            ...
                            for (int i = 0; i < xmlSmaliProperties.LinesCount; i++)
                            {
                                if (xmlSmaliProperties.Lines[i].PartialContains(xmlSmaliSearchKeys[0]))
                                {
                                    for (int j = i; j <= scaleIndex.Lines(i, 8); j++)
                                    {
                                        if (xmlSmaliProperties.Lines[j].PartialContains(xmlSmaliSearchKeys[1]))
                                        {
                                            string priorityConstregister = xmlSmaliProperties.Lines[j].GetRegister(3);

                                            codeInject.Lines(
                                                [
                                                    ("Litho UI Threads Low Priority",

                                                    j,

                                                    [
                                                        $"const/4 {priorityConstregister}, 0x0",
                                                        $"invoke-static {{}}, L{uUtilsPath};->GetThreadMinPriority()I",
                                                        $"move-result {priorityConstregister}"
                                                    ])
                                                ]
                                            ).Write();
                                    ...
                                    for (int j = i; j <= scaleIndex.Lines(i, 26); j++)
                                    {
                                        if (xmlSmaliProperties.Lines[j].PartialContains(xmlSmaliSearchKeys[3]))
                                        {
                                            for (int k = j; k < xmlSmaliProperties.LinesCount; k++)
                                            {
                                                if (xmlSmaliProperties.Lines[k].PartialContains(xmlSmaliSearchKeys[4]))
                                                {
                                                    string firstPriorityConstregister = xmlSmaliProperties.Lines[j].GetRegister(1);
                                                    string secondPriorityConstregister = xmlSmaliProperties.Lines[k].GetRegister(2);
                                                    ...
                                                    codeInject.Lines(
                                                        [
                                                            ...
                                                            [
                                                                $"const/4 {secondPriorityConstregister}, 0x0",
                                                                $"invoke-static {{}}, L{uUtilsPath};->GetThreadMinPriority()I",
                                                                $"move-result {secondPriorityConstregister}"
                                                            ]),
                                                            ...
                                                            [
                                                                $"const/4 {firstPriorityConstregister}, 0x0",
                                                                $"invoke-static {{}}, L{uUtilsPath};->GetThreadMinPriority()I",
                                                                $"move-result {firstPriorityConstregister}"
                                                            ])
                                                        ]
                                                    ).Write();
                                                                    ...
                                                                    for (int n = m; n <= scaleIndex.ProxiedLines(m, 5); n++)
                                                                    {
                                                                        if (xmlSmaliProperties.ProxiedLines[n].PartialContains(xmlSmaliSearchKeys[2]))
                                                                        {
                                                                            codeInject.ProxiedLinesReplace(
                                                                                [
                                                                                    ("Automatic App Rotation Disabler",
        ...
        public static List<bool> My_Tab_Horizontal_Shelfs_Preservation()
        {
            return [
                new SmaliUtils.SubPatchModule<string[]>(
                    [
                                                        ...
                                                        if (xmlSmaliProperties.ProxiedLines[l].PartialContains(xmlSmaliSearchKeys[4]))
                                                        {
                                                            codeInject.ProxiedLines(
                                                                [
                                                                    ...
                                                                    [
                                                                        $"invoke-static {{{xmlSmaliProperties.ProxiedLines[l].GetRegister(2)}}}, L{uUtilsPath};->SetCurrentNavBarIndex(I)V"
                                                                    ])
                                                                ]
                                                            ).Write();
                                                        ...
                                                        if (xmlSmaliProperties.ProxiedLines[l].PartialContains(xmlSmaliSearchKeys[3]))
                                                        {
                                                            codeInject.ProxiedLines(
                                                                [
                                                                    ...
                                                                    [
                                                                        "const/4 v0, 0x0",
                                                                        $"invoke-static {{v0}}, L{uUtilsPath};->SetCurrentNavBarIndex(I)V"
                                                                    ])
                                                                ]
                                                            ).Write();
