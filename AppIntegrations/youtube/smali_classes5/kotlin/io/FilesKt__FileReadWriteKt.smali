...
.method public static synthetic useLines$default(Ljava/io/File;Ljava/nio/charset/Charset;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .local p3, "charset$iv":Ljava/nio/charset/Charset;
    move-object p4, p0

    .local p4, "$this$useLines$iv":Ljava/io/File;
    const/4 v0, 0x0
    ...
    invoke-direct {v1, v2, p3}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    ...
    .line 235
    .local v2, "it$iv":Ljava/io/BufferedReader;
    const/4 v3, 0x0

    .line 234
    .local v3, "$i$a$-use-FilesKt__FileReadWriteKt$useLines$1$iv":I
    invoke-static {v2}, Lkotlin/io/TextStreamsKt;->lineSequence(Ljava/io/BufferedReader;)Lkotlin/sequences/Sequence;
    ...
    .end local v2    # "it$iv":Ljava/io/BufferedReader;
    .end local v3    # "$i$a$-use-FilesKt__FileReadWriteKt$useLines$1$iv":I
    const/4 v2, 0x0
    ...
    .line 230
    .end local v0    # "$i$f$useLines":I
    .end local p3    # "charset$iv":Ljava/nio/charset/Charset;
    .end local p4    # "$this$useLines$iv":Ljava/io/File;
    return-object v4

    .line 234
    .restart local v0    # "$i$f$useLines":I
    .restart local p3    # "charset$iv":Ljava/nio/charset/Charset;
    .restart local p4    # "$this$useLines$iv":Ljava/io/File;
    :catchall_0
    move-exception v2
