...
.method public run()V
    ...
    .line 59
    .local v2, "$i$a$-synchronized-TaskRunner$runnable$1$run$task$1":I
    :try_start_0
    ...
    .line 58
    .end local v2    # "$i$a$-synchronized-TaskRunner$runnable$1$run$task$1":I
    monitor-exit v0
    ...
    .line 65
    :try_start_1
    # invokes: Lokhttp3/internal/concurrent/TaskRunner;->runTask(Lokhttp3/internal/concurrent/Task;)V
    ...
    .end local p0    # "this":Lokhttp3/internal/concurrent/TaskRunner$runnable$1;
    throw v10
    :try_end_3
    ...
    .restart local p0    # "this":Lokhttp3/internal/concurrent/TaskRunner$runnable$1;
    :goto_1
    if-eqz v6, :cond_4
