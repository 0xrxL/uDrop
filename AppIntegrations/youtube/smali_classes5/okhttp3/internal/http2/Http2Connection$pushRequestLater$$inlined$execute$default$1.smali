...
.method public runOnce()J
    ...
    .line 219
    .local v0, "$i$a$-execute$default-Http2Connection$pushRequestLater$2":I
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;->$requestHeaders$inlined:Ljava/util/List;
    ...
    .line 223
    .local v3, "$i$a$-ignoreIoExceptions-Http2Connection$pushRequestLater$2$1":I
    if-eqz v1, :cond_0

    .line 224
    :try_start_0
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;->this$0:Lokhttp3/internal/http2/Http2Connection;

    invoke-virtual {v4}, Lokhttp3/internal/http2/Http2Connection;->getWriter()Lokhttp3/internal/http2/Http2Writer;

    move-result-object v4

    iget v5, p0, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;->$streamId$inlined:I
    ...
    .line 226
    .local v5, "$i$a$-synchronized-Http2Connection$pushRequestLater$2$1$1":I
    :try_start_1
    iget-object v6, p0, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;->this$0:Lokhttp3/internal/http2/Http2Connection;
    ...
    iget v7, p0, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;->$streamId$inlined:I
    ...
    .line 225
    .end local v5    # "$i$a$-synchronized-Http2Connection$pushRequestLater$2$1$1":I
    :try_start_2
    monitor-exit v4
    ...
    .end local v0    # "$i$a$-execute$default-Http2Connection$pushRequestLater$2":I
    .end local v1    # "cancel":Z
    .end local v2    # "$i$f$ignoreIoExceptions":I
    .end local p0    # "this":Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;
    throw v5
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0

    .line 230
    .end local v3    # "$i$a$-ignoreIoExceptions-Http2Connection$pushRequestLater$2$1":I
    .restart local v0    # "$i$a$-execute$default-Http2Connection$pushRequestLater$2":I
    .restart local v1    # "cancel":Z
    .restart local v2    # "$i$f$ignoreIoExceptions":I
    .restart local p0    # "this":Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$default$1;
    :catch_0
    move-exception v3
    ...
    .line 229
    .restart local v3    # "$i$a$-ignoreIoExceptions-Http2Connection$pushRequestLater$2$1":I
    :cond_0
    :goto_0
    nop
