...
.method static constructor <clinit>()V
    ...
    sput-object v0, LuTools/StreamSpoofing/uStreamingDataRequest;->CLIENT_TYPES_ORDER_TO_USE:Ljava/util/List;
    ...
    .line 84
    .local v0, "clientTypes":[LuTools/StreamSpoofing/uClientType;
    sget-object v1, LuTools/StreamSpoofing/uClientType;->ANDROID_VR:LuTools/StreamSpoofing/uClientType;

    .line 86
    .local v1, "preferredClientType":LuTools/StreamSpoofing/uClientType;
    sget-object v3, LuTools/StreamSpoofing/uStreamingDataRequest;->CLIENT_TYPES_ORDER_TO_USE:Ljava/util/List;
    ...
    .line 89
    .local v4, "clientType":LuTools/StreamSpoofing/uClientType;
    if-eq v4, v1, :cond_0

    .line 90
    sget-object v5, LuTools/StreamSpoofing/uStreamingDataRequest;->CLIENT_TYPES_ORDER_TO_USE:Ljava/util/List;

    invoke-interface {v5, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 88
    .end local v4    # "clientType":LuTools/StreamSpoofing/uClientType;
    :cond_0
    ...
    .line 93
    .end local v0    # "clientTypes":[LuTools/StreamSpoofing/uClientType;
    .end local v1    # "preferredClientType":LuTools/StreamSpoofing/uClientType;
    :cond_1
    return-void
.end method
...
.method private constructor <init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v0}, LuTools/StreamSpoofing/uSpoofingUtils;->submitOnBackgroundThread(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
...
.method private static fetch(Ljava/lang/String;Ljava/util/Map;)Ljava/nio/ByteBuffer;
    ...
    sget-object v0, LuTools/StreamSpoofing/uStreamingDataRequest;->CLIENT_TYPES_ORDER_TO_USE:Ljava/util/List;
    ...
    check-cast v1, LuTools/StreamSpoofing/uClientType;

    .line 97
    .local v1, "clientType":LuTools/StreamSpoofing/uClientType;
    const-string v2, "uStreamingDataRequest"

    invoke-virtual {v1}, LuTools/StreamSpoofing/uClientType;->name()Ljava/lang/String;
    ...
    .line 99
    invoke-static {v1, p0, p1}, LuTools/StreamSpoofing/uStreamingDataRequest;->send(LuTools/StreamSpoofing/uClientType;Ljava/lang/String;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v7, v6, v10, v9}, Ljava/lang/String;-><init>([BII)V

    .line 112
    invoke-static {v7}, LuTools/StreamSpoofing/uStreamingDataRequest;->isLiveStream(Ljava/lang/String;)Z
    ...
    .end local v1    # "clientType":LuTools/StreamSpoofing/uClientType;
    ...
    .restart local v1    # "clientType":LuTools/StreamSpoofing/uClientType;
...
.method private static isLiveStream(Ljava/lang/String;)Z
    .locals 3
    .param p0, "streamingData"    # Ljava/lang/String;
    ...
    const-string v2, "yt_live_broadcast"

    aput-object v2, v0, v1

    const/4 v1, 0x1

    const-string v2, "yt_premiere_broadcast"
    ...
    new-instance v1, LuTools/StreamSpoofing/uStreamingDataRequest$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, LuTools/StreamSpoofing/uStreamingDataRequest$$ExternalSyntheticLambda1;-><init>(Ljava/lang/String;)V
